...
class PDF extends tFPDF {
    function Footer() {
        ...
        $this->Cell(95,4,"[ 1 ] - M. ou Mme le Préfet $dataConfig[departement]",'LT',0);
        $this->Cell(35,4,$date_cloture,'LTR',0,'C');
        $this->Cell(60,4,"Le $date_cloture",'RT',1,'C');
        
        $this->Cell(95,4,"[ 1 ] - M. ou Mme le Maire - $dataSecours[loc_commune]",'L',0);
...
$pdf->SetFont('Arial','B',9);
$pdf->Cell(115,4,'PROCES VERBAL DE RENSEIGNEMENT ADMINISTRATIF','',1);
$pdf->SetFont('DejaVu','',9);
...
while ($dataMoyens = $enqueteurs->fetch()) {
    ...
    $pdf->Cell(0,4,"$dataMoyens[grade] $dataMoyens[prenom] $dataMoyens[nom] en résidence à $dataConfig[commune]",'',1);
    $pdf->SetLeftMargin(10);
};

$pdf->Ln(0);
$pdf->Cell(0,4,"Vu l'article L.421-1 du code de la sécurité intérieure",'',1);
